# BlueVisa｜教大学生 eVisa 预查

BlueVisa 是由 Blue 发起的免费开源公益项目，帮助香港教育大学学生读取入境处申请档案编号（`immdRefNo`），并用简体中文说明后续的 eVisa 官方下载步骤。
...
不少同学完成材料递交后，仍不清楚 MEEN 开头的编号是什么、在哪里找到，以及拿到编号后应到哪里下载 eVisa。BlueVisa 希望把这些散落的信息整理成清晰、可核验的下一步指引，让等待来港读书的同学少一点信息差。

项目作者：**Blue**。查询逻辑、字段白名单、服务器部署方式和本机插件均公开在本仓库，欢迎审阅和改进。
